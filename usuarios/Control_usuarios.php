						...
						<div class="row gtr-uniform">
								...
								<div class="col-6 col-12-xsmall">	
									...
									<select name="buscadorcategoria" id="buscadorcategoria" onchange="myFunction(event)">	
										<option value="1">ID del usuario</option>
										<option value="2">Por Nombre del usuario</option>
										<option value="3">Por NickName del usuario</option>
										<option value="4">Por Email del usuario</option>
